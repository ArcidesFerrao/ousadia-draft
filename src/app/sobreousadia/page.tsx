      ...
      <div className="header">
        ...
        <div className="about-header-details mx-4 flex flex-col gap-4">
          <p className="text-lg font-thin">
            ...
            produz camisetas pretas com frases temáticas cômicas, de motivação,
            fé e positividade.
          </p>
          <p className="text-lg font-thin">
          ...
          <p className="text-lg font-thin">
            A marca orgulha-se pelo trabalho feito em duas coleções lançadas, e
            uma Collab no período 2021 - 2023. Actualmente possui um leque de
            várias camisetas cujos lançamentos são feitos mensalmente desde
            agosto de 2024.
          </p>
          <p className="text-lg font-thin">
            Com abertura para colaborar com artistas, individualidades e jovens
            criativos moçambicanos, a Ousadia compromete-se a criar uma cultura
            de vestuário casual que não apenas se encaixa na moda, mas que
            também serve de uma forma de comunicação social.
          </p>
        </div>
